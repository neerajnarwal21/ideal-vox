...
import com.pugtools.fcalendar.view.LockScrollView;
...
public abstract class UICalendar extends LinearLayout {
    ...
    private Drawable mTodayItemBackgroundDrawable =
            getResources().getDrawable(R.drawable.circle_semi_white_background);
    private int mSelectedItemTextColor = Color.BLACK;
    ...
    public void setStyle(int style) {
        ...
        if (style == STYLE_LIGHT) {
            ...
            setTodayItemBackgroundDrawable(
                    getResources().getDrawable(R.drawable.circle_semi_white_background));
            setSelectedItemTextColor(Color.BLACK);
